(function () {
  ...
  factorial.onclick = () => {
    ...
    if (isNaN(result.innerHTML)) {
      ...
      let blueHistory =
        "<span style='color:#4728E1'>" + " Please correct." + "</span>";
      historyContent.insertAdjacentHTML(
        "beforeend",
        oldresult.innerHTML + blueHistory + "<br>"
      );
      historyContent.innerHTML = "";
    } else {
      historyContent.innerHTML = oldresult.innerHTML + result.innerHTML;
      let blueHistory =
        "<span style='color:#4728E1'>" +
        " " +
        historyContent.innerHTML.substring(
          historyContent.innerHTML.indexOf("=") + "=".length
        ) +
        "</span>";
      historyContent.insertAdjacentHTML(
        "afterend",
  ...
  root.onclick = () => {
    ...
    result.innerHTML =
      Math.sqrt(result.innerHTML).toFixed(5).replace(/\.0+$/, "") * 1;
  ...
  square.onclick = () => {
    ...
    oldresult.innerHTML = `(${result.innerHTML})²=`;
    result.innerHTML =
      Math.pow(result.innerHTML, 2).toFixed(5).replace(/\.0+$/, "") * 1;
    historyContent.innerHTML = oldresult.innerHTML + result.innerHTML;
    let blueHistory =
      "<span style='color:#4728E1'>" +
      " " +
  ...
  sign.onclick = () => {
    ...
    if (oldresult.innerHTML.includes(plus.innerHTML)) {
      oldresult.innerHTML =
        oldresult.innerHTML.substring(
          0,
          oldresult.innerHTML.lastIndexOf(plus.innerHTML)
        ) +
        plus.innerHTML +
        oldresult.innerHTML.substring(
          oldresult.innerHTML.lastIndexOf(plus.innerHTML) + 1
        ) *
          -1;
      ...
      oldresult.innerHTML =
        oldresult.innerHTML.substring(
          0,
          oldresult.innerHTML.lastIndexOf(multiply.innerHTML)
        ) +
        multiply.innerHTML +
        oldresult.innerHTML.substring(
          oldresult.innerHTML.lastIndexOf(multiply.innerHTML) + 1
        ) *
          -1;
      result.innerHTML = result.innerHTML * -1;
      ...
      oldresult.innerHTML =
        oldresult.innerHTML.substring(
          0,
          oldresult.innerHTML.lastIndexOf(divide.innerHTML)
        ) +
        divide.innerHTML +
        oldresult.innerHTML.substring(
          oldresult.innerHTML.lastIndexOf(divide.innerHTML) + 1
        ) *
          -1;
      result.innerHTML = result.innerHTML * -1;
    } else if (oldresult.innerHTML.includes("^")) {
      oldresult.innerHTML =
        oldresult.innerHTML.substring(0, oldresult.innerHTML.lastIndexOf("^")) +
        "^" +
        oldresult.innerHTML.substring(
          oldresult.innerHTML.lastIndexOf("^") + 1
        ) *
          -1;
      result.innerHTML = result.innerHTML * -1;
    } else {
  ...
  equal.onclick = () => {
    ...
    if (
      ...
      isNaN(oldresult.innerHTML.slice(-1))
    ) {
      equal.disabled = true;
    } else {
      ...
      if (oldresult.innerHTML.includes(plus.innerHTML)) {
        result.innerHTML =
          (
            parseFloat(`${oldresult.innerHTML.split(plus.innerHTML)[0]}`) +
            parseFloat(`${oldresult.innerHTML.split(plus.innerHTML)[1]}`)
          )
            .toFixed(5)
            .replace(/\.0+$/, "") * 1;
      } else if (
        oldresult.innerHTML.includes(minus.innerHTML) &&
        !oldresult.innerHTML.includes(multiply.innerHTML) &&
        !oldresult.innerHTML.includes(divide.innerHTML) &&
        !oldresult.innerHTML.includes("^")
      ) {
        result.innerHTML =
          (
            parseFloat(
              `${oldresult.innerHTML.substring(
                0,
                oldresult.innerHTML.lastIndexOf(minus.innerHTML)
              )}`
            ) -
            parseFloat(
              `${oldresult.innerHTML.substring(
                oldresult.innerHTML.lastIndexOf(minus.innerHTML) + 1
              )}`
            )
          )
            .toFixed(5)
        ...
        result.innerHTML =
          Math.pow(
            parseFloat(
              `${oldresult.innerHTML.substring(
                0,
                oldresult.innerHTML.lastIndexOf("^")
              )}`
            ),
            parseFloat(
              `${oldresult.innerHTML.substring(
    ...
    if (
      oldresult.innerHTML.slice(-1) == "+" ||
      oldresult.innerHTML.slice(-1) == "-" ||
      oldresult.innerHTML.slice(-1) == "x" ||
      oldresult.innerHTML.slice(-1) == "÷" ||
      oldresult.innerHTML.slice(-1) == "."
    ) {
      historyContent.innerHTML = oldresult.innerHTML + result.innerHTML;
  ...
  historyExport.onclick = () => {
    ...
    fileDownload.download =
      "Calculator History_" + new Date().toLocaleString() + ".doc";
    fileDownload.click();
